 ...
 * Plugin URI: 
 * Description: Take credit card payments on your store. (Features : CC Form)
...
function tap_init_gateway_class() {
    ...
    public function payment_scripts() {
			...
			wp_localize_script( 'woocommerce_tap', 'tap_params', array('publishableKey' => $this->live_public_key));
		...
		public function payment_fields() {		
			...
			echo '<form id="form-container" method="post" action="">
                    ...
                    <span id="token"></span>
          			...
          			<!-- Tap pay button -->
          			<button id="tap-btn"style="display: none;visibility: hidden;">Submit</button>
      					'.'
	 	...
	 	public function process_payment($order_id) {
				...
				$token = new WC_Payment_Token_CC();
	 			...
	 			$wooToken = isset($_POST['tap-woo-token']) ? $_POST['tap-woo-token'] : '';
